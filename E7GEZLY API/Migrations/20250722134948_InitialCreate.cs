        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumberVerificationCodeExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerProfiles_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerProfiles_DistrictId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_District_GovernorateId_NameEn",
                table: "Districts",
                columns: new[] { "GovernorateId", "NameEn" });

            migrationBuilder.CreateIndex(
                name: "IX_Governorate_NameAr",
                table: "Governorates",
                column: "NameAr");

            migrationBuilder.CreateIndex(
                name: "IX_Governorate_NameEn",
                table: "Governorates",
                column: "NameEn");
